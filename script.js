...
btn.addEventListener('click', () => {
    ...
    document.getElementById('out-years').innerText = y;
    document.getElementById('out-months').innerText = m;
    document.getElementById('out-days').innerText = d;
});